...
description: "Router for EXL Cloud Tier 4 governance, analysis, and delivery. Sub-skills: (9) Assumption Register Builder; (10) Anomaly Detection — PASS/FAIL validation checks; (11) Model Documentation Generator; (12) Variance Analysis Reporter — actuals vs budget/forecast; (13) KPI Dashboard Formatter — traffic light dashboard; (14) Change Log & Audit Trail; (15) Meeting Prep Pack. Reference by number e.g. 'use skill 9', 'run skill 12', 'skill 15'. Trigger phrases — skill 9: 'extract assumptions'; skill 10: 'add validation checks', 'PASS FAIL'; skill 11: 'document this model'; skill 12: 'variance analysis', 'actual vs budget'; skill 13: 'build a dashboard', 'KPI tiles'; skill 14: 'add change log', 'audit trail'; skill 15: 'meeting prep', 'board meeting brief'. Always views the correct Reference/ file before proceeding — never guesses."
---
