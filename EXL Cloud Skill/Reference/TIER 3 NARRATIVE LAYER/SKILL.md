...
description: "Router for EXL Cloud Tier 3 narrative and reporting outputs. Covers: (1) monthly P&L management commentary — use for 'write commentary', 'monthly commentary', 'explain the P&L', 'management narrative', 'write up the month', 'financial narrative'; (2) full board paper assembly — use for 'draft the board paper', 'board report', 'board pack', 'board meeting paper', 'executive summary for board'; (3) cash flow narrative — use for 'explain cash flow', 'cash narrative', 'what happened to cash', 'cash position summary', 'cash movements'. Always views the correct Reference/ file before proceeding — never guesses."
---
